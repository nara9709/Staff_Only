...
function CalendarModal({ onSubmit, onClose }: Props) {
  ...
  return (
    <div className=" bg-[#176B87] w-full h-full fixed top-[50%] rounded-lg max-w-7xl m-auto p-2">
      <form className="flex flex-col items-center justify-center pt-8 px-8 pb-4 relative">
        ...
        <input
          ...
          value={startTime}
          className=" rounded-md text-lg p-[0.7rem] mb-2 focus:outline-none w-full 
           "
        />
        ...
        <input
          ...
          value={endTime}
          className=" rounded-md text-lg p-[0.7rem] w-full focus:outline-none  "
        />
